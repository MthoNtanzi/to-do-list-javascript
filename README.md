...
The purpose of this project is to build a solid understanding of how modern front-end frameworks work under the hood by manually handling:
...
* Data persistence with the Web Storage API
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/MthoNtanzi/to-do-list-javascript.git
   ```
